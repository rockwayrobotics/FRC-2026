...
public class ModuleIOSpark implements ModuleIO {
    ...
    public void updateInputs(ModuleIOInputs inputs) {
        ...
        ifOk(
                ...
                (value) -> inputs.turnPosition = new Rotation2d(MathUtil.inputModulus(value, 0, Math.PI * 2)));
        ifOk(
                turnSpark,
                () -> turnSpark.getEncoder().getPosition(),
                (value) -> inputs.turnRelativePosition = new Rotation2d(MathUtil.inputModulus(value, 0, Math.PI * 2)));
        ifOk(
                turnSpark,

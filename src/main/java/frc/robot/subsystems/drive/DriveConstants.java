...
public class DriveConstants {
  ...
  public static final double driveKp = 0.008; // 0.01;
  public static final double driveKd = 0.0; // 0.25
  public static final double driveKs = 0.09485;
  public static final double driveKv = 0.1; // 0.08447; // 0.1; // 0.2375;
  ...
  public static final double robotMassKg = 64.8138137;
  ...
  public static final SwerveModuleConfig[] swerveModuleConfigs = {
    ...
    SwerveModuleConfig.builder()
        ...
        .encoderOffset(Rotation2d.fromRadians(-5.452 + Math.PI / 4))
        .turnInverted(true)
    ...
    SwerveModuleConfig.builder()
        ...
        .absoluteEncoder(false)
        // .encoderOffset(Rotation2d.fromRadians(0))
        .encoderOffset(Rotation2d.fromRadians(-3.026 - Math.PI / 4))
        .turnInverted(true)
        .encoderInverted(false)
        .build(),
    // BL
    SwerveModuleConfig.builder()
        ...
        .absoluteEncoder(false)
        // .encoderOffset(Rotation2d.fromRadians(0))
        .encoderOffset(Rotation2d.fromRadians(-5.785 + 3 * Math.PI / 4))
        .turnInverted(true)
        .encoderInverted(false)
        .build(),
    // BR
    SwerveModuleConfig.builder()
        ...
        .absoluteEncoder(false)
        // .encoderOffset(Rotation2d.fromRadians(0))
        .encoderOffset(Rotation2d.fromRadians(-4.859 - 3 * Math.PI / 4))
        .turnInverted(true)
        .encoderInverted(false)
        .build()
  };

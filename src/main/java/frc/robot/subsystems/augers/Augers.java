...
public class Augers extends SubsystemBase { //Defines every Subsystem
  private final AugersIO augersIO; //Instance of AugersIO interface that becomes AugersReal or AugersSim
  private final AugersIOInputsAutoLogged augersInputs = new AugersIOInputsAutoLogged(); //Instance

  public Augers(AugersIO augersIO) { // Constructor: Mandatory to new class; [NewClass] = python '__init__'

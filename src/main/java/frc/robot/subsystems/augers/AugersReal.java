...
public class AugersReal implements AugersIO {
  ...
  public void updateInputs(AugersIOInputs inputs) {
    SparkUtil.ifOk(motor, motorEncoder::getVelocity, (value) -> inputs.velocityRadsPerSec = value);
    SparkUtil.ifOk(motor, new DoubleSupplier[] {motor::getAppliedOutput, motor::getBusVoltage}, (values) -> inputs.appliedVolts = values[0] * values[1]);
  }
}
